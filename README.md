...
## Validator Testing
### Pylint
The Pylint score initially returned a rating of roughly seven (exact figure undocumented). Through code correct, it was possible to increase the score to 9.83. Two issues remained.
